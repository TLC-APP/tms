...
class MessagesController extends AppController {
    ...
    public function getLastMessage($group_alias = null) {
        ...
        $messages = $this->Message->find('all', array('conditions' => $conditions, 'contain' => $contain, 'limit' => 5,'order'=>array('Message.created'=>'DESC')));
    ...
    public function manager_add() {
        ...
        $categories = $this->Message->Group->find('list', array('conditions' => array('NOT' => array('Group.alias' => array('admin', 'manager', 'fields_manager','boss')))));
