<div class="jobs-wrapper col-md-10 col-sm-7">           
    ...
    <div class="box box-border page-row">
        <ul class="list-unstyled">
            ...
            <li><strong>Ngày sinh:</strong> <?php $ngaysinh=new DateTime($user['User']['birthday']); echo $ngaysinh->format('d/m/Y'); ?></li>
    ...
    <div class="box-footer">
        <div class="box-tools">
            <?php echo $this->Html->link('Sửa', array('guest' => true, 'controller' => 'users', 'action' => 'edit_profile', $user['User']['id']), array('class' => 'btn btn-info')); ?>
        </div>
    </div>
    <br>
</div>