                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($attend['is_recieved'])
                                                            echo $this->Form->postLink('<button type="button" class="btn btn-warning">Hủy nhận</button>', array('manager'=>false,'controller' => 'attends', 'action' => 'cancel_recieve', $attend['id']), array('escape' => false), __('Bạn có chắc hủy nhận bằng?'));
                                                        ?>
                                                        <?php
                                                        if ($attend['is_recieved'] == 0 && $attend['is_passed'] == 1)
                                                            echo $this->Form->postLink('<button type="button" class="btn btn-warning">Nhận</button>', array('manager'=>false,'controller' => 'attends', 'action' => 'recieve', $attend['id']), array('escape' => false), __('Người này chắc nhận bằng?'));
                                                        ?></td>
                                                    <td><?php
