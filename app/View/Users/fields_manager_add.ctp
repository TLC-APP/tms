<div class="container">
    ...
    <fieldset>
        ...
        echo $this->Form->input('hoc_ham_id', array('label' => 'Học hàm','empty'=>'-- Chọn học hàm --', 'id'=>'UserHocHamId','empty' => '-- Chọn học hàm --',
            'after' => $this->Html->link('<span class="glyphicon glyphicon-plus"></span>', '/hochams/add', array('escape' => false,
                'class' => 'add-button btn btn-primary fancybox.ajax', 'role' => 'button', 'div' => false))));
        echo $this->Form->input('hoc_vi_id', array('label' => 'Học vị','empty'=>'-- Chọn học vị --','id'=>'UserHocViId', 'after' => $this->Html->link('<span class="glyphicon glyphicon-plus"></span>', '/hocvis/add', array('escape' => false, 'class' => 'add-button btn btn-primary fancybox.ajax', 'role' => 'button', 'div' => false))));
