        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i> <span>Đang đăng ký</span>', array('controller' => 'courses','plugin'=>false, 'action' => 'index', 'admin' => true, COURSE_REGISTERING), array('escape' => false)); ?></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>                    
                        <?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i>Danh sách', array( 'controller' => 'rooms', 'action' => 'index','plugin'=>false), array('escape' => false)); ?>
                    </li>
                    <li>                    
                        <?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i>Thêm mới', array( 'controller' => 'rooms', 'action' => 'add','plugin'=>false), array('escape' => false)); ?>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i>Danh sách', array( 'controller' => 'messages', 'action' => 'index','plugin'=>false), array('escape' => false)); ?>

                    </li>
                    <li>                    
                        <?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i>Thêm mới', array( 'controller' => 'messages', 'action' => 'add','plugin'=>false), array('escape' => false)); ?>
                    </li>
                </ul>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i> <span>Danh sách</span>', array('controller' => 'users', 'action' => 'index', 'admin' => true,'plugin'=>false), array('escape' => false)); ?></li>
                    <li><?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i> <span>Thêm người dùng</span>', array('controller' => 'users', 'action' => 'add', 'admin' => true,'plugin'=>false), array('escape' => false)); ?></li>
                   <li><?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i> <span>Thêm nhóm</span>', array('controller' => 'groups', 'action' => 'add', 'admin' => true,'plugin'=>false), array('escape' => false)); ?></li>
            ...
            <li class="treeview">
             ...
             <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>                    
                        <?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i>Danh sách', array('admin' => true, 'controller' => 'departments', 'action' => 'index','plugin'=>false), array('escape' => false)); ?>
                    </li>
                    <li>                    
                        <?php echo $this->Html->link('<i class="fa fa-angle-double-right"></i>Thêm mới', array('admin' => true, 'controller' => 'departments', 'action' => 'add','plugin'=>false), array('escape' => false)); ?>
                    </li>
