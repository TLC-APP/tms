<aside class="left-side sidebar-offcanvas">
    ...
    <section class="sidebar">
        <!-- Sidebar user panel -->
        <!-- search form -->
        <form action="<?php echo SUB_DIR;?>/fields_manager/users/search" method="post" class="sidebar-form">
            <div class="input-group">
                
                <input type="text" name="name" class="form-control" placeholder="Nhập tên tập huấn viên..."/>
