...
<div class="panel panel-theme">
    <div class="panel-heading">
        <h3 class="panel-title"><i class=" glyphicon glyphicon-bullhorn"></i> Khóa học mới đăng ký</h3>
    </div>
...
<div class="panel panel-theme">
    <div class="panel-heading">
        <h3 class="panel-title"><i class=" glyphicon glyphicon-bullhorn"></i> Bạn chưa đăng ký khóa học mới nào.</h3>
    </div>
   </div>
<?php }?>
