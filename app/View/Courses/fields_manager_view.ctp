            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div id="tab_hoc_vien" class="tab-pane">
                        ...
                        <?php
                        if ($course['Course']['status'] == COURSE_REGISTERING) {
                            echo $this->element('fields_manager/course/view/course_registering_students', array('students' => $course['Attend']));
                            echo $this->Html->link('IN DS học viên', '/courses/print_student/' . $course['Course']['id'], array('class' => 'btn btn-info'));
                        }
                        ?>
                    ...
                    <div id="tab_2-2" class="tab-pane">
                        <table class="table table-condensed">
                            ...
                            <tbody style="font-size: 15px;">
                                ...
                                <tr><td>Đã xuất bản</td><td><?php  if ($course['Course']['is_published'] == 1)
                                            echo 'Có';
                                        else
                                            echo 'Không'; ?></td></tr>
                                <tr><td> Tình trạng</td><td><?php
                                        if ($course['Course']['status'] == 1)
                                            echo 'Đang đăng ký';
                                        if ($course['Course']['status'] == 3)
                                            echo 'Chưa hoàn thành';
                                        if ($course['Course']['status'] == 4)
                                            echo 'Đã hoàn thành';
                                        if ($course['Course']['status'] == 5)
                                            echo 'Đã hủy';
                                        ?></td></tr>
                                <tr>
                                    <td>Chuyên đề</td>
