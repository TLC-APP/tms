            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab_1-1" class="tab-pane active">
                        <div class="noi_dung" >
                                <img alt="" class="img-responsive"  style="padding-right: 10px; width: 500px;" src="/files/course/image/<?php echo $course['Course']['image_path'] . '/' . $course['Course']['image']; ?>">

                            <p><?php echo $course['Course']['decription']; ?></p>
                            <?php echo $this->Html->link('<button class="btn btn-info">' . 'Sửa' . '</button>', array('teacher' => true, 'controller' => 'courses', 'action' => 'edit', $course['Course']['id']), array('escape' => false, 'class' => 'add-button fancybox.ajax')) ?>
                        </div>
                    </div><!-- /.tab-pane -->
